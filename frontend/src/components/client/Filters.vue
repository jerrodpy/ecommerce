<template>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <button @click="$emit('apply')" class="btn btn-primary w-100 mb-2">Застосувати</button>
      <button @click="$emit('reset')" class="btn btn-outline-secondary w-100">Скинути</button>
    </div>
  </div>
</template>
