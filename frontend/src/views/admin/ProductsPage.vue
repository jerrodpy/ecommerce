<template>
  <div>
    ...
    <div class="alert alert-info">
      <i class="bi bi-info-circle"></i> Адміністратор може додавати, редагувати та видаляти товари
      із завантаженням зображень та вибором категорій
    </div>

    <button @click="startAddProduct" class="btn btn-success btn-lg mb-4">
          ...
          <table class="table table-hover mb-0">
            ...
            <tbody>
              <tr v-if="products.length === 0">
                <td colspan="6" class="text-center text-muted py-4">Немає товарів</td>
              </tr>
              <tr v-for="product in products" :key="product.id">
                ...
                <td>
                  <span v-for="cat in product.categories" :key="cat.id" class="badge bg-info me-1">
                    {{ cat.title }}
                  </span>
                  <span
